...
export const MAIN_BRANCH_COUNT = 10;           // how many main 'trunk' tips from center
...
export const MAX_BRANCH_DEPTH = 50000;        // how many times we can nest branches
...
export const BASE_NUTRIENT = 5;               // baseline nutrient level in each cell
export const BASE_MOISTURE = 5;               // baseline moisture level
...
export const INITIAL_RESOURCE_PER_TIP = 10.0; // how much resource a new tip starts with
 ...
 */
export const TIME_LAPSE_FACTOR = 10;
 ...
 */
export const SECONDARY_FAN_COUNT = 50;
...
// Perlin Noise
export const PERLIN_SCALE = 0.1;
export const ANGLE_DRIFT_STRENGTH = 0.01;
export const WIGGLE_STRENGTH = 0.5;
...
export const MAIN_LINE_WIDTH = 3.0;
